...
(function (global, factory) {
  ...
  var TableResultAction = function (startPoint, where, action, domTable) {
       ...
       *
       * @param {int} rowIndex ProductLibrary position in line of virtual table.
       * @param {int} cellIndex ProductLibrary position in column of virtual table.
       ...
       *
       * @param {int} rowIndex ProductLibrary of row to find free space.
       * @param {int} cellIndex ProductLibrary of cell to find free space in table.
       */
