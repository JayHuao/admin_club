...
(function ($) {
    ...
    $.fn.fileinputLocales['de'] = {
        ...
        msgSizeTooSmall: 'Datei "{name}" (<b>{size} KB</b>) unterschreitet mindestens notwendige File-Größe von <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Datei "{name}" (<b>{size} KB</b>) überschreitet maximal zulässige File-Größe von <b>{maxSize} KB</b>.',
        ...
        msgUploadAborted: 'Der Datei-File wurde abgebrochen',
        ...
        msgResumableUploadRetriesExceeded:  'File aborted beyond <b>{max}</b> retries for file <b>{file}</b>! Error Details: <pre>{error}</pre>',
        msgPendingTime: '{time} remaining',
        msgCalculatingTime: 'calculating time remaining',
        ajaxOperations: {
            deleteThumb: 'Datei löschen',
            uploadThumb: 'Datei hochladen',
            uploadBatch: 'Batch-Datei-File',
            uploadExtra: 'Formular-Datei-File'
        },
